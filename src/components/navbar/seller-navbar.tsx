...
const NAV_ITEMS = [
  ...
  { label: "Earnings/Payout", href: "/seller/earnings", icon: Wallet },
  { label: "Store settings", href: "/seller/store-settings", icon: Store },
    ...
    <aside className="flex h-screen w-60 flex-col bg-[#12233F] text-white">
      <div className="flex items-center gap-2 px-5 py-5">
        ...
        <div className="leading-tight">
          <div className="font-semibold text-[15px]">Seller Panel</div>
